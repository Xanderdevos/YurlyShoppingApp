...
public class OpenScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    FirebaseDatabase.getInstance().getReference("sellers/" + user.getUid())
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    // text shown when the sign process is succesfully completed
        ...
        // code executed when loginbutton is pressed
        loginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // progressbar is shown while waiting for information is retrieved from the database
                progressBar.setVisibility(View.VISIBLE);

                // set text form the editTextFields to string, so it is corretly entered in the database
        ...
        // go to register page when the user hasn't created a account yet
        ...
        // go to seller register page when seller hasn't created a account yet
